...
There are many researches trying to use CNN to classify CU splitting. [Xu2018b]_ achieve averagely 65\% reduction of HEVC encoding time under inter mode by using CNN and Long Term Short Term Memory (LSTM). 
